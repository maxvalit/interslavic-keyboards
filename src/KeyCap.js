...
const svgs = {
    ...
    'enter': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M13 8L17 8" stroke="#222222" strokeLinecap="round"/>
    ...
    'ctrl': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5 12L5 4" stroke="#222222" strokeLinecap="round"/>
        <path d="M19 20L19 17" stroke="#222222" strokeLinecap="round"/>
        <path d="M5 20L5 16" stroke="#222222" strokeLinecap="round"/>
        <path d="M19 13L19 4" stroke="#222222" strokeLinecap="round"/>
        <path d="M12 7L12 4" stroke="#222222" strokeLinecap="round"/>
        <path d="M12 20L12 11" stroke="#222222" strokeLinecap="round"/>
        <circle cx="5" cy="14" r="2" stroke="#222222" strokeLinecap="round"/>
        <circle cx="12" cy="9" r="2" stroke="#222222" strokeLinecap="round"/>
        <circle cx="19" cy="15" r="2" stroke="#222222" strokeLinecap="round"/>
    </svg>
    ,
    ...
    'alt': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            stroke="#222222"/>
        <path d="M18.5 4L17 6H19L17.5 8" stroke="#7E869E" strokeOpacity="0.25" strokeLinecap="round"
              strokeLinejoin="round"/>
        <path d="M6.5 16L5 18H7L5.5 20" stroke="#7E869E" strokeOpacity="0.25" strokeLinecap="round"
              strokeLinejoin="round"/>
    </svg>,
...
export function KeyCap(
    ...
    return <div
        ...
        className={`cap ${type} ${sz} ${isPressed} ${className} ${modifierClass} ${contolClass} ${highlightClass}`}>
